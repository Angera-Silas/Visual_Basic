...
Public Class FutureValue
    ...
    Public Sub GetDimensions()
        ...
        Console.WriteLine("How is the investment compounded? i.e annualy or semi-anualy or quaterly, etc")
        op = Console.ReadLine
        op = op.ToLower()
        If(op = "annualy") Then
            m = 1
        ElseIf(op = "semi-annualy") Then
            m = 2
    ...
    Public Sub Display()
        ...
        Console.WriteLine("Compunded     : {0}",op)
